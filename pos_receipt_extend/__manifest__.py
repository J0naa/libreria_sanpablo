...
#############################################################################
{
    ...
    'depends': ['point_of_sale', 'sale','nuc_facturacion'],
    'data': [
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'pos_receipt_extend/static/src/xml/OrderReceipt.xml',
             'pos_receipt_extend/static/src/xml/pos_receipts_fw.xml',
            'pos_receipt_extend/static/src/xml/receipt_order_data.xml',
            'pos_receipt_extend/static/src/xml/pos_receipt_taxes.xml',
